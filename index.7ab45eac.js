 ...
 * limitations under the License.
 */
const ft="firebase-heartbeat-store";let mt=null;function _t(){return mt||(mt=Ke("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(ft)}}).catch((e=>{throw lt.create("idb-open",{originalErrorMessage:e.message})}))),mt}async function gt(e,t){var n;try{const n=(await _t()).transaction(ft,"readwrite"),i=n.objectStore(ft);return await i.put(t,vt(e)),n.done}catch(e){if(e instanceof X)tt.warn(e.message);else{const t=lt.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});tt.warn(t.message)}}}function vt(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Sn(e,t=[]){let n;switch(e){case"Browser":n=_n($());break;case"Worker":n=`${_n($())}-${e}`;break;default:n=e}return`${n}/JsCore/9.9.4/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
function mi(){return void 0!==fi().WorkerGlobalScope&&"function"==typeof fi().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class vo extends Vs{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?qr(e.name,t.name):r}makePost(e,t){const n=go(e),i=mo.EMPTY_NODE.updateChild(this.indexPath_,n);return new Ws(t,i)}maxPost(){const e=mo.EMPTY_NODE.updateChild(this.indexPath_,_o);return new Ws(Br,e)}toString(){return Rs(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,M(!As(e)&&".priority"!==ks(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ta(e,t,n,i,r){const s=new wa;let o,a;if(n.type===Do.OVERWRITE){const c=n;c.source.fromUser?o=Sa(e,t,c.path,c.snap,i,r,s):(M(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!As(c.path),o=ka(e,t,c.path,c.snap,i,r,a,s))}else if(n.type===Do.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,i,r,s,o){let a=t;return i.foreach(((i,c)=>{const l=xs(n,i);Pa(t,ks(l))&&(a=Sa(e,a,l,c,r,s,o))})),i.foreach(((i,c)=>{const l=xs(n,i);Pa(t,ks(l))||(a=Sa(e,a,l,c,r,s,o))})),a}(e,t,c.path,c.children,i,r,s):(M(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Ra(e,t,c.path,c.children,i,r,a,s))}else if(n.type===Do.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,r,s){let o;if(null!=_a(i,n))return t;{const a=new Ca(i,t,r),c=t.eventCache.getNode();let l;if(As(n)||".priority"===ks(n)){let n;if(t.serverCache.isFullyInitialized())n=pa(i,Ko(t));else{const e=t.serverCache.getNode();M(e instanceof mo,"serverChildren would be complete if leaf node"),n=fa(i,e)}l=e.filter.updateFullNode(c,n,s)}else{const r=ks(n);let h=va(i,r,t.serverCache);null==h&&t.serverCache.isCompleteForChild(r)&&(h=c.getImmediateChild(r)),l=null!=h?e.filter.updateChild(c,r,h,Ps(n),a,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(c,r,mo.EMPTY_NODE,Ps(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=pa(i,Ko(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=_a(i,Es()),Vo(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
