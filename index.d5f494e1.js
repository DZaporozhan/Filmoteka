 ...
 * limitations under the License.
 */
class Ja{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Qa(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||ps(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Xa(e,t,n){Qa(e,n),Za(e,(e=>fs(e,t)||fs(t,e)))}function Za(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(ec(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function ec(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();mr&&yr("event: "+n.toString()),Lr(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tc{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ja,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=oo(),this.transactionQueueTree_=new Da,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function nc(e,t,n){if(e.stats_=zr(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new ro(e.repoInfo_,((t,n,i,r)=>{sc(e,t,n,i,r)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>oc(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{se(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new ys(e.repoInfo_,t,((t,n,i,r)=>{sc(e,t,n,i,r)}),(t=>{oc(e,t)}),(t=>{!function(e,t){Rr(t,((t,n)=>{ac(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return Vr[n]||(Vr[n]=t()),Vr[n]}(e.repoInfo_,(()=>new ho(e.stats_,e.server_))),e.infoData_=new so,e.infoSyncTree_=new _a({startListening:(t,n,i,r)=>{let s=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=va(e.infoSyncTree_,t._path,o),setTimeout((()=>{r("ok")}),0)),s},stopListening:()=>{}}),ac(e,"connected",!1),e.serverSyncTree_=new _a({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,((n,i)=>{const s=r(n,i);Xa(e.eventQueue_,t._path,s)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function ic(e){const t=e.infoData_.getNode(new ns(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function rc(e){return(t=(t={timestamp:ic(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function sc(e,t,n,i,r){e.dataUpdateCount++;const s=new ns(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r)if(i){const t=de(n,(e=>Ks(e)));o=function(e,t,n,i){const r=Ta(e,i);if(r){const i=Ea(r),s=i.path,o=i.queryId,a=ds(s,t),c=ko.fromObject(n);return ka(e,s,new go(fo(o),a,c))}return[]}(e.serverSyncTree_,s,t,r)}else{const t=Ks(n);o=ya(e.serverSyncTree_,s,t,r)}else if(i){const t=de(n,(e=>Ks(e)));o=function(e,t,n){const i=ko.fromObject(n);return wa(e,new go({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,s,t)}else{const t=Ks(n);o=va(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=pc(e,s)),Xa(e.eventQueue_,a,o)}function oc(e,t){ac(e,"connected",t),!1===t&&function(e){hc(e,"onDisconnectEvents");const t=rc(e),n=oo();co(e.onDisconnect_,is(),((i,r)=>{const s=Aa(i,r,e.serverSyncTree_,t);ao(n,i,s)}));let i=[];co(n,is(),((t,n)=>{i=i.concat(va(e.serverSyncTree_,t,n));const r=vc(e,t);pc(e,r)})),e.onDisconnect_=oo(),Xa(e.eventQueue_,is(),i)}(e)}function ac(e,t,n){const i=new ns("/.info/"+t),r=Ks(n);e.infoData_.updateSnapshot(i,r);const s=va(e.infoSyncTree_,i,r);Xa(e.eventQueue_,i,s)}function cc(e){return e.nextWriteId_++}function lc(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function hc(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),yr(n,...t)}function uc(e,t,n){return ba(e.serverSyncTree_,t,n)||zs.EMPTY_NODE}function dc(e,t=e.transactionQueueTree_){if(t||gc(e,t),Fa(t)){const n=_c(e,t);j(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),r=uc(e,t,i);let s=r;const o=r.hash();for(let e=0;e<n.length;e++){const i=n[e];j(0===i.status,"tryToSendTransactionQueue_: items in queue should all be run."),i.status=1,i.retryCount++;const r=ds(t,i.path);s=s.updateChild(r,i.currentOutputSnapshotRaw)}const a=s.val(!0),c=t;e.server_.put(c.toString(),a,(i=>{hc(e,"transaction put response",{path:c.toString(),status:i});let r=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,r=r.concat(ga(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();gc(e,Ma(e.transactionQueueTree_,t)),dc(e,e.transactionQueueTree_),Xa(e.eventQueue_,t,r);for(let e=0;e<i.length;e++)Lr(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Cr("transaction at "+c.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}pc(e,t)}}),o)}(e,Ha(t),n)}else ja(t)&&Ba(t,(t=>{dc(e,t)}))}function pc(e,t){const n=fc(e,t),i=Ha(n);return function(e,t,n){if(0===t.length)return;const i=[];let r=[];const s=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const c=t[a],l=ds(n,c.path);let h,u=!1;if(j(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===c.status)u=!0,h=c.abortReason,r=r.concat(ga(e.serverSyncTree_,c.currentWriteId,!0));else if(0===c.status)if(c.retryCount>=25)u=!0,h="maxretry",r=r.concat(ga(e.serverSyncTree_,c.currentWriteId,!0));else{const n=uc(e,c.path,s);c.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){Ga("transaction failed: Data returned ",i,c.path);let t=Ks(i);"object"==typeof i&&null!=i&&le(i,".priority")||(t=t.updatePriority(n.getPriority()));const o=c.currentWriteId,a=rc(e),l=xa(t,n,a);c.currentOutputSnapshotRaw=t,c.currentOutputSnapshotResolved=l,c.currentWriteId=cc(e),s.splice(s.indexOf(o),1),r=r.concat(ma(e.serverSyncTree_,c.path,l,c.currentWriteId,c.applyLocally)),r=r.concat(ga(e.serverSyncTree_,o,!0))}else u=!0,h="nodata",r=r.concat(ga(e.serverSyncTree_,c.currentWriteId,!0))}Xa(e.eventQueue_,n,r),r=[],u&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===h?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(h),!1,null)))))}var o;gc(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)Lr(i[e]);dc(e,e.transactionQueueTree_)}(e,_c(e,n),i),i}function fc(e,t){let n,i=e.transactionQueueTree_;for(n=rs(t);null!==n&&void 0===Fa(i);)i=Ma(i,n),n=rs(t=os(t));return i}function _c(e,t){const n=[];return mc(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function mc(e,t,n){const i=Fa(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);Ba(t,(t=>{mc(e,t,n)}))}function gc(e,t){const n=Fa(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Ua(t,n.length>0?n:void 0)}Ba(t,(t=>{gc(e,t)}))}function vc(e,t){const n=Ha(fc(e,t)),i=Ma(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{yc(e,t)})),yc(e,i),qa(i,(t=>{yc(e,t)})),n}function yc(e,t){const n=Fa(t);if(n){const i=[];let r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(j(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(j(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(ga(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===s?Ua(t,void 0):n.length=s+1,Xa(e.eventQueue_,Ha(t),r);for(let e=0;e<i.length;e++)Lr(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ic{get key(){return us(this._path)?null:as(this._path)}get ref(){return new Cc(this._repo,this._path)}get _queryIdentifier(){const e=io(this._queryParams),t=Nr(e);return"{}"===t?"default":t}get _queryObject(){return io(this._queryParams)}isEqual(e){if(!((e=Ee(e))instanceof Ic))return!1;const t=this._repo===e._repo,n=ps(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}}class Cc extends Ic{get parent(){const e=ls(this._path);return null===e?null:new Cc(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new to,!1)}}!function(e){j(!ua,"__referenceConstructor has already been defined"),ua=e}(Cc),function(e){j(!da,"__referenceConstructor has already been defined"),da=e}(Cc);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Tc={};let Ec=!1;function kc(e,t,n,i,r){let s=i||e.options.databaseURL;void 0===s&&(e.options.projectId||Ir("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),yr("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,c=bc(s,r),l=c.repoInfo;void 0!==sr&&sr.env&&(a=sr.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${l.namespace}`,c=bc(s,r),l=c.repoInfo):o=!c.repoInfo.secure;const h=r&&o?new Ur(Ur.OWNER):new Fr(e.name,e.options,t);Ya("Invalid Firebase Database URL",c),us(c.path)||Ir("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let r=Tc[t.name];r||(r={},Tc[t.name]=r);let s=r[e.toURLString()];s&&Ir("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new tc(e,Ec,n,i),r[e.toURLString()]=s,s}(l,e,h,new Mr(e.name,n));return new Sc(u,e)}class Sc{get _repo(){return this._instanceStarted||(nc(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Cc(this._repo,is())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Tc[t];n&&n[e.key]===e||Ir(`Database ${t}(${e.repoInfo_}) has already been deleted.`),lc(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Ir("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}ys.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},ys.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){or="9.9.4",ot(new ke("database",((e,{instanceIdentifier:t})=>kc(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ut("@firebase/database","0.13.6",e),ut("@firebase/database","0.13.6","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */})),c.default.signUpForm.addEventListener("submit",(function(e){e.preventDefault(),ei(Pc.currentUser,{displayName:`${userData.name}`}),Zn(Pc,userData.email,userData.pass).then((e=>{e.user})).catch((e=>{const t=e.code,n=e.message;alert(t,n)})),alert(`User ${userData.name} created`),ti(Pc).then((()=>{c.default.library.classList.add("hidden-item")})),userData.name="",userData.pass="",userData.email="",location.reload()})),document.addEventListener("keydown",Rc),Oc=e=>{e?(c.default.library.classList.remove("hidden-item"),c.default.openAuth.classList.add("hidden-item"),c.default.logOut.classList.remove("hidden-item")):(c.default.library.classList.add("hidden-item"),c.default.openAuth.classList.remove("hidden-item"),c.default.logOut.classList.add("hidden-item"))},Ee(Pc).onAuthStateChanged(Oc,Ac,xc);c=s("krGWQ");var Mc=s("i1OHb");const Fc=new a;function Uc(e){const t=e.target.nodeName,n=e.target.closest(".movieCard"),i=Number(n.getAttribute("data"));var r;r=i,Fc.getMoviesByID(r).then((e=>{jc=e})),"IMG"!==t&&"P"!==t||(c.default.modalFilmInfoRef.addEventListener("click",Bc),c.default.modalFilmInfoRef.addEventListener("click",qc))}c.default.mainList.addEventListener("click",Uc),c.default.mainList.addEventListener("click",Uc);let jc={};function Bc(e){if("modal-btn modal-film_btn-watched"===e.target.className){const e=[];e.push(jc),Hc(e,"watched")}}function qc(e){if("modal-btn modal-film_btn-queue"===e.target.className){const e=[];e.push(jc),Hc(e,"queue")}}function Hc(e,t){const n=e.map((e=>e.id));let i=[...n];if((0,Mc.load)(t)){const r=(0,Mc.load)(t);let s=r.map((e=>e.id));r.push(...e),i=[...new Set([...n,...s])],e.push(...r)}!function(e,t,n){let i=[];for(let n=0;n<e.length;n+=1){let r=e[n],s=t.find((e=>e.id===r));i.push(s)}(0,Mc.save)(n,i)}(i,e,t)}
//# sourceMappingURL=index.d5f494e1.js.map
