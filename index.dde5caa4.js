 ...
 * limitations under the License.
 */
function be(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function we(){return"undefined"!=typeof window&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(be())}function Ie(){return"object"==typeof navigator&&"ReactNative"===navigator.product}function xe(){return!0===ue||!0===ce}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var Jt="firebase-heartbeat-store",Yt=null;function Qt(){return Yt||(Yt=xt("firebase-heartbeat-database",1,{upgrade:function(e,t){if(0===t)e.createObjectStore(Jt)}}).catch((function(e){throw Wt.create("idb-open",{originalErrorMessage:e.message})}))),Yt}function Xt(e){return $t.apply(this,arguments)}function $t(){return($t=t(o)(t(c).mark((function e(n){var r,i,a;return t(c).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=1,e.next=4,Qt();case 4:return i=e.sent,e.abrupt("return",i.transaction(Jt).objectStore(Jt).get(tn(n)));case 8:e.prev=8,e.t0=e.catch(1),e.t0 instanceof Te?Lt.warn(e.t0.message):(a=Wt.create("idb-get",{originalErrorMessage:null===(r=e.t0)||void 0===r?void 0:r.message}),Lt.warn(a.message));case 11:case"end":return e.stop()}}),e,null,[[1,8]])})))).apply(this,arguments)}function Zt(e,t){return en.apply(this,arguments)}function en(){return(en=t(o)(t(c).mark((function e(n,r){var i,a,o,s,u;return t(c).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=1,e.next=4,Qt();case 4:return a=e.sent,o=a.transaction(Jt,"readwrite"),s=o.objectStore(Jt),e.next=9,s.put(r,tn(n));case 9:return e.abrupt("return",o.done);case 12:e.prev=12,e.t0=e.catch(1),e.t0 instanceof Te?Lt.warn(e.t0.message):(u=Wt.create("idb-set",{originalErrorMessage:null===(i=e.t0)||void 0===i?void 0:i.message}),Lt.warn(u.message));case 15:case"end":return e.stop()}}),e,null,[[1,12]])})))).apply(this,arguments)}function tn(e){return"".concat(e.name,"!").concat(e.options.appId)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Cn=new Map;function En(e){Tn(e instanceof Function,"Expected a class definition");var t=Cn.get(e);return t?(Tn(t instanceof e,"Instance stored in cache mismatched with class"),t):(t=new e,Cn.set(e,t),t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var An=function(){"use strict";function e(n,r){t(s)(this,e),this.shortDelay=n,this.longDelay=r,Tn(r>n,"Short delay should be less than long delay!"),this.isMobile=we()||Ie()}return t(u)(e,[{key:"get",value:function(){return On()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}]),e}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ln(e,t){Tn(e.emulator,"Emulator should always be set here");var n=e.emulator.url;return t?"".concat(n).concat(t.startsWith("/")?t.slice(1):t):n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var jr=function(){"use strict";function e(n,r){t(s)(this,e),this.providerId=n,this.signInMethod=r}return t(u)(e,[{key:"toJSON",value:function(){return xn("not implemented")}},{key:"_getIdTokenResponse",value:function(e){return xn("not implemented")}},{key:"_linkToIdToken",value:function(e,t){return xn("not implemented")}},{key:"_getReauthenticationResolver",value:function(e){return xn("not implemented")}}]),e}();function Br(e,t){return qr.apply(this,arguments)}function qr(){return(qr=t(o)(t(c).mark((function e(n,r){return t(c).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Bn(n,"POST","/v1/accounts:update",r));case 1:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function Hr(e,t){return Wr.apply(this,arguments)}function Wr(){return(Wr=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}var Il=/[\[\].#$\/\u0000-\u001F\u007F]/,xl=/[\[\].#$\u0000-\u001F\u007F]/,Tl=10485760,Cl=function(e){return"string"==typeof e&&0!==e.length&&!Il.test(e)},El=function(e){return"string"==typeof e&&0!==e.length&&!xl.test(e)},Sl=function(e,t,n){var r=n instanceof Ss?new qs(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Ws(r));if("function"==typeof t)throw new Error(e+"contains a function "+Ws(r)+" with contents = "+t.toString());if(qo(t))throw new Error(e+"contains "+t.toString()+" "+Ws(r));if("string"==typeof t&&t.length>3495253.3333333335&&Ge(t)>Tl)throw new Error(e+"contains a string greater than "+"10485760 utf8 bytes "+Ws(r)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){var i=!1,a=!1;if(Yo(t,(function(t,n){if(".value"===t)i=!0;else if(".priority"!==t&&".sv"!==t&&(a=!0,!Cl(t)))throw new Error(e+" contains an invalid key ("+t+") "+Ws(r)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');var o,s;s=t,(o=r).parts_.length>0&&(o.byteLength_+=1),o.parts_.push(s),o.byteLength_+=Ge(s),Hs(o),Sl(e,n,r),function(e){var t=e.parts_.pop();e.byteLength_-=Ge(t),e.parts_.length>0&&(e.byteLength_-=1)}(r)})),i&&a)throw new Error(e+' contains ".value" child '+Ws(r)+" in addition to actual children.")}},Pl=function(e,t){var n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Cl(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),El(e)}(n))throw new Error(ze(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')},Rl=function e(){"use strict";t(s)(this,e),this.eventLists_=[],this.recursionDepth_=0};function Nl(e,t){for(var n=null,r=0;r<t.length;r++){var i=t[r],a=i.getPath();null===n||js(a,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:a}),n.events.push(i)}n&&e.eventLists_.push(n)}function Ol(e,t,n){Nl(e,n),Al(e,(function(e){return Bs(e,t)||Bs(t,e)}))}function Al(e,t){e.recursionDepth_++;for(var n=!0,r=0;r<e.eventLists_.length;r++){var i=e.eventLists_[r];if(i)t(i.path)?(Ll(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}n&&(e.eventLists_=[]),e.recursionDepth_--}function Ll(e){for(var t=0;t<e.events.length;t++){var n=e.events[t];if(null!==n){e.events[t]=null;var r=n.getEventRunner();Ao&&Mo("event: "+n.toString()),ts(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Dl="repo_interrupt",Ml=function(){"use strict";function e(n,r,i,a){t(s)(this,e),this.repoInfo_=n,this.forceRestClient_=r,this.authTokenProvider_=i,this.appCheckProvider_=a,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Rl,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Uu(),this.transactionQueueTree_=new pl,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}return t(u)(e,[{key:"toString",value:function(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}]),e}();function Fl(e,t,n){if(e.stats_=vs(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Mu(e.repoInfo_,(function(t,n,r,i){Bl(e,t,n,r,i)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((function(){return ql(e,!0)}),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Re(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Ks(e.repoInfo_,t,(function(t,n,r,i){Bl(e,t,n,r,i)}),(function(t){ql(e,t)}),(function(t){!function(e,t){Yo(t,(function(t,n){Hl(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}var r,i,a;e.authTokenProvider_.addTokenChangeListener((function(t){e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((function(t){e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=(r=e.repoInfo_,i=function(){return new Vu(e.stats_,e.server_)},a=r.toString(),ps[a]||(ps[a]=i()),ps[a]),e.infoData_=new Fu,e.infoSyncTree_=new Jc({startListening:function(t,n,r,i){var a=[],o=e.infoData_.getNode(t._path);return o.isEmpty()||(a=Xc(e.infoSyncTree_,t._path,o),setTimeout((function(){i("ok")}),0)),a},stopListening:function(){}}),Hl(e,"connected",!1),e.serverSyncTree_=new Jc({startListening:function(t,n,r,i){return e.server_.listen(t,r,n,(function(n,r){var a=i(n,r);Ol(e.eventQueue_,t._path,a)})),[]},stopListening:function(t,n){e.server_.unlisten(t,n)}})}function Ul(e){var t=e.infoData_.getNode(new Ss(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function jl(e){return(t=(t={timestamp:Ul(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function Bl(e,t,n,r,i){e.dataUpdateCount++;var a=new Ss(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;var o=[];if(i)if(r){var s=Me(n,(function(e){return wu(e)}));o=function(e,t,n,r){var i=rl(e,r);if(i){var a=il(i),o=a.path,s=a.queryId,u=Us(o,t),c=ic.fromObject(n);return al(e,o,new Yu(zu(s),u,c))}return[]}(e.serverSyncTree_,a,s,i)}else{var u=wu(n);o=$c(e.serverSyncTree_,a,u,i)}else if(r){var c=Me(n,(function(e){return wu(e)}));o=function(e,t,n){var r=ic.fromObject(n);return el(e,new Yu({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,r))}(e.serverSyncTree_,a,c)}else{var l=wu(n);o=Xc(e.serverSyncTree_,a,l)}var h=a;o.length>0&&(h=Yl(e,a)),Ol(e.eventQueue_,h,o)}function ql(e,t){Hl(e,"connected",t),!1===t&&function(e){zl(e,"onDisconnectEvents");var t=jl(e),n=Uu();Bu(e.onDisconnect_,Ps(),(function(r,i){var a=hl(r,i,e.serverSyncTree_,t);ju(n,r,a)}));var r=[];Bu(n,Ps(),(function(t,n){r=r.concat(Xc(e.serverSyncTree_,t,n));var i=eh(e,t);Yl(e,i)})),e.onDisconnect_=Uu(),Ol(e.eventQueue_,Ps(),r)}(e)}function Hl(e,t,n){var r=new Ss("/.info/"+t),i=wu(n);e.infoData_.updateSnapshot(r,i);var a=Xc(e.infoSyncTree_,r,i);Ol(e.eventQueue_,r,a)}function Wl(e){return e.nextWriteId_++}function Vl(e){e.persistentConnection_&&e.persistentConnection_.interrupt(Dl)}function zl(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),i=1;i<n;i++)r[i-1]=arguments[i];var a="";e.persistentConnection_&&(a=e.persistentConnection_.id+":"),Mo.apply(void 0,[a].concat(t(v)(r)))}function Kl(e,t,n){return Zc(e.serverSyncTree_,t,n)||ku.EMPTY_NODE}function Gl(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:e.transactionQueueTree_;if(t||Zl(e,t),ml(t)){var n=Xl(e,t);he(n.length>0,"Sending zero length transaction queue");var r=n.every((function(e){return 0===e.status}));r&&Jl(e,bl(t),n)}else _l(t)&&gl(t,(function(t){Gl(e,t)}))}function Jl(e,t,n){for(var r=n.map((function(e){return e.currentWriteId})),i=Kl(e,t,r),a=i,o=i.hash(),s=0;s<n.length;s++){var u=n[s];he(0===u.status,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;var c=Us(t,u.path);a=a.updateChild(c,u.currentOutputSnapshotRaw)}var l=a.val(!0),h=t;e.server_.put(h.toString(),l,(function(r){zl(e,"transaction put response",{path:h.toString(),status:r});var i=[];if("ok"===r){for(var a=function(t){n[t].status=2,i=i.concat(Qc(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&o.push((function(){return n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved)})),n[t].unwatcher()},o=[],s=0;s<n.length;s++)a(s);Zl(e,vl(e.transactionQueueTree_,t)),Gl(e,e.transactionQueueTree_),Ol(e.eventQueue_,t,i);for(var u=0;u<o.length;u++)ts(o[u])}else{if("datastale"===r)for(var c=0;c<n.length;c++)3===n[c].status?n[c].status=4:n[c].status=0;else{Bo("transaction at "+h.toString()+" failed: "+r);for(var l=0;l<n.length;l++)n[l].status=4,n[l].abortReason=r}Yl(e,t)}}),o)}function Yl(e,t){var n=Ql(e,t),r=bl(n);return function(e,t,n){var r=function(r){var s,u=t[r],c=Us(n,u.path),l=!1,h=void 0;if(he(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===u.status)l=!0,h=u.abortReason,a=a.concat(Qc(e.serverSyncTree_,u.currentWriteId,!0));else if(0===u.status)if(u.retryCount>=25)l=!0,h="maxretry",a=a.concat(Qc(e.serverSyncTree_,u.currentWriteId,!0));else{var d=Kl(e,u.path,o);u.currentInputSnapshot=d;var f=t[r].update(d.val());if(void 0!==f){Sl("transaction failed: Data returned ",f,u.path);var p=wu(f);"object"==typeof f&&null!=f&&Ae(f,".priority")||(p=p.updatePriority(d.getPriority()));var v=u.currentWriteId,m=jl(e),y=dl(p,d,m);u.currentOutputSnapshotRaw=p,u.currentOutputSnapshotResolved=y,u.currentWriteId=Wl(e),o.splice(o.indexOf(v),1),a=(a=a.concat(Yc(e.serverSyncTree_,u.path,y,u.currentWriteId,u.applyLocally))).concat(Qc(e.serverSyncTree_,v,!0))}else l=!0,h="nodata",a=a.concat(Qc(e.serverSyncTree_,u.currentWriteId,!0))}Ol(e.eventQueue_,n,a),a=[],l&&(t[r].status=2,s=t[r].unwatcher,setTimeout(s,Math.floor(0)),t[r].onComplete&&("nodata"===h?i.push((function(){return t[r].onComplete(null,!1,t[r].currentInputSnapshot)})):i.push((function(){return t[r].onComplete(new Error(h),!1,null)}))))};if(0===t.length)return;for(var i=[],a=[],o=t.filter((function(e){return 0===e.status})).map((function(e){return e.currentWriteId})),s=0;s<t.length;s++)r(s);Zl(e,e.transactionQueueTree_);for(var u=0;u<i.length;u++)ts(i[u]);Gl(e,e.transactionQueueTree_)}(e,Xl(e,n),r),r}function Ql(e,t){var n,r=e.transactionQueueTree_;for(n=Rs(t);null!==n&&void 0===ml(r);)r=vl(r,n),n=Rs(t=Os(t));return r}function Xl(e,t){var n=[];return $l(e,t,n),n.sort((function(e,t){return e.order-t.order})),n}function $l(e,t,n){var r=ml(t);if(r)for(var i=0;i<r.length;i++)n.push(r[i]);gl(t,(function(t){$l(e,t,n)}))}function Zl(e,t){var n=ml(t);if(n){for(var r=0,i=0;i<n.length;i++)2!==n[i].status&&(n[r]=n[i],r++);n.length=r,yl(t,n.length>0?n:void 0)}gl(t,(function(t){Zl(e,t)}))}function eh(e,t){var n=bl(Ql(e,t)),r=vl(e.transactionQueueTree_,t);return function(e,t,n){for(var r=n?e:e.parent;null!==r;){if(t(r))return!0;r=r.parent}}(r,(function(t){th(e,t)})),th(e,r),kl(r,(function(t){th(e,t)})),n}function th(e,t){var n=ml(t);if(n){for(var r=[],i=[],a=-1,o=0;o<n.length;o++)3===n[o].status||(1===n[o].status?(he(a===o-1,"All SENT items should be at beginning of queue."),a=o,n[o].status=3,n[o].abortReason="set"):(he(0===n[o].status,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(Qc(e.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&r.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));-1===a?yl(t,void 0):n.length=a+1,Ol(e.eventQueue_,bl(t),i);for(var s=0;s<r.length;s++)ts(r[s])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var oh={},sh=!1;function uh(e,t,n,r,i){var a=r||e.options.databaseURL;void 0===a&&(e.options.projectId||jo("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Mo("Using default host for project ",e.options.projectId),a="".concat(e.options.projectId,"-default-rtdb.firebaseio.com"));var o,s=nh(a,i),u=s.repoInfo,c=void 0;void 0!==go&&go.env&&(c=go.env.FIREBASE_DATABASE_EMULATOR_HOST),c?(o=!0,a="http://".concat(c,"?ns=").concat(u.namespace),u=(s=nh(a,i)).repoInfo):o=!s.repoInfo.secure;var l=i&&o?new as(as.OWNER):new is(e.name,e.options,t);Pl("Invalid Firebase Database URL",s),Fs(s.path)||jo("Database URL must point to the root of a Firebase Database (not including a child path).");var h=function(e,t,n,r){var i=oh[t.name];i||(i={},oh[t.name]=i);var a=i[e.toURLString()];a&&jo("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return a=new Ml(e,sh,n,r),i[e.toURLString()]=a,a}(u,e,l,new rs(e.name,n));return new ch(h,e)}var ch=function(){"use strict";function e(n,r){t(s)(this,e),this._repoInternal=n,this.app=r,this.type="database",this._instanceStarted=!1}return t(u)(e,[{key:"_repo",get:function(){return this._instanceStarted||(Fl(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}},{key:"_root",get:function(){return this._rootInternal||(this._rootInternal=new ah(this._repo,Ps())),this._rootInternal}},{key:"_delete",value:function(){var e,t,n;return null!==this._rootInternal&&(e=this._repo,t=this.app.name,(n=oh[t])&&n[e.key]===e||jo("Database ".concat(t,"(").concat(e.repoInfo_,") has already been deleted.")),Vl(e),delete n[e.key],this._repoInternal=null,this._rootInternal=null),Promise.resolve()}},{key:"_checkNotDeleted",value:function(e){null===this._rootInternal&&jo("Cannot call "+e+" on a deleted database.")}}]),e}();Ks.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Ks.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){wo=zt,Bt(new Qe("database",(function(e,t){var n=t.instanceIdentifier;return uh(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),n)}),"PUBLIC").setMultipleInstances(!0)),Gt(ko,bo,e),Gt(ko,bo,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Kt(),t=qt(e,"auth");return t.isInitialized()?t.getImmediate():Sn(e,{popupRedirectResolver:lo,persistence:[ua,Ui,Bi]})}(fh);!function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Kt(),t=arguments.length>1?arguments[1]:void 0;qt(e,"database").getImmediate({identifier:t})}(fh);function vh(e){"button"!==e.target.type&&"email"!==e.target.type&&"password"!==e.target.type&&"text"!==e.target.type&&"Enter"!==e.code&&("submit"===e.target.type||(e.code,d.default.backdropAuth.classList.add("is-hidden"),d.default.body.classList.remove("no-scroll")))}function mh(e){e.preventDefault(),d.default.modalSignUp.classList.add("hidden-item"),d.default.modalSignIn.classList.remove("hidden-item")}function yh(e){e.preventDefault(),d.default.modalSignUp.classList.remove("hidden-item"),d.default.modalSignIn.classList.add("hidden-item")}d.default.logOut.addEventListener("click",(function(){ph.currentUser;Ai(ph).then((function(){location.reload()})),alert("You are logged out")})),d.default.toLogInTab.addEventListener("click",mh),d.default.toSignUpTab.addEventListener("click",yh),d.default.toLogIn.addEventListener("click",mh),d.default.toSignUp.addEventListener("click",yh),d.default.openAuth.addEventListener("click",(function(){d.default.backdropAuth.classList.remove("is-hidden"),d.default.body.classList.add("no-scroll")})),d.default.backdropAuth.addEventListener("click",vh),d.default.signInForm.addEventListener("submit",(function(e){e.preventDefault();ph.currentUser;var t={email:document.getElementById("auth-email").value,pass:document.getElementById("auth-password").value};if(d.default.backdropAuth.classList.remove("is-hidden"),d.default.body.classList.add("no-scroll"),!t.email||!t.pass)return void alert("Please enter your email and password");(n=ph,r=t.email,i=t.pass,Ti(Je(n),oi.credential(r,i))).then((function(e){var n=e.user;d.default.library.classList.remove("hidden-item"),t.email="",t.pass="",alert("User ".concat(n.displayName," signed in")),location.reload()})).catch((function(e){var t=e.code,n=e.message;alert(t,n)}));var n,r,i})),d.default.signUpForm.addEventListener("submit",(function(e){e.preventDefault(),Ni(ph.currentUser,{displayName:"".concat(userData.name)}),Ei(ph,userData.email,userData.pass).then((function(e){e.user})).catch((function(e){var t=e.code,n=e.message;alert(t,n)})),alert("User ".concat(userData.name," created")),Ai(ph).then((function(){d.default.library.classList.add("hidden-item")})),userData.name="",userData.pass="",userData.email="",location.reload()})),document.addEventListener("keydown",vh),lh=function(e){e?(d.default.library.classList.remove("hidden-item"),d.default.openAuth.classList.add("hidden-item"),d.default.logOut.classList.remove("hidden-item")):(d.default.library.classList.add("hidden-item"),d.default.openAuth.classList.remove("hidden-item"),d.default.logOut.classList.add("hidden-item"))},Je(ph).onAuthStateChanged(lh,hh,dh);d=a("4Nugj");var _h=a("fctGW"),gh=new h;function kh(e){var t=e.target.nodeName,n=e.target.closest(".movieCard");!function(e){gh.getMoviesByID(e).then((function(e){bh=e}))}(Number(n.getAttribute("data"))),"IMG"!==t&&"P"!==t||(d.default.modalFilmInfoRef.addEventListener("click",wh),d.default.modalFilmInfoRef.addEventListener("click",Ih))}d.default.mainList.addEventListener("click",kh),d.default.mainList.addEventListener("click",kh);var bh={};function wh(e){if("modal-btn modal-film_btn-watched"===e.target.className){var t=[];t.push(bh),xh(t,"watched")}}function Ih(e){if("modal-btn modal-film_btn-queue"===e.target.className){var t=[];t.push(bh),xh(t,"queue")}}function xh(e,n){var r=e.map((function(e){return e.id})),i=t(v)(r);if((0,_h.load)(n)){var a,o,s=(0,_h.load)(n),u=s.map((function(e){return e.id}));(a=s).push.apply(a,t(v)(e)),i=t(v)(new Set(t(v)(r).concat(t(v)(u)))),(o=e).push.apply(o,t(v)(s))}!function(e,t,n){for(var r=function(n){var r=e[n],a=t.find((function(e){return e.id===r}));i.push(a)},i=[],a=0;a<e.length;a+=1)r(a);(0,_h.save)(n,i)}(i,e,n)}}();
//# sourceMappingURL=index.dde5caa4.js.map
