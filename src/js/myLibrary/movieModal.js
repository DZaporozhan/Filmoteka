...
//     const movieId = movieData.find(id => movieData.id === id);
//     if (movieId) {
//       openModal();
//     }

//     const modal = await createModalFilmMarkup(movieData);
//     refs.modalFilmInfoRef.insertAdjacentHTML('beforeend', modal);
//   } catch (error) {
...
//       <p class="modal-film__table-value">${generateGenreListForModalFromLocalStorage(
//         genres
//       )}</p>
//     </li>
//   </ul>
...
// function generateGenreListForModalFromLocalStorage(genres) {
